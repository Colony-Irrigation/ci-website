        ...
        <section className="-mt-3 bg-white rounded-t-xl z-10 relative font-sans">
            <div className="bg-amber-950/12 p-3 pt-12 rounded-t-xl ">
                <div className="text-center text-lg font-sans max-w-200 mx-auto">
                    ...
                    Since 2003, we have provided <span className="font-semibold">professional</span> and <span className="font-semibold">affordable</span> lawncare, landscaping, irrigation, and hardscape services for customers in the Canton, Michigan area.
                </div>
