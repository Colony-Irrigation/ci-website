...
export default function IrrigationSection() {
    return <ServiceSection title="Irrigation" id="irrigation">
        <p className="mb-6">
            Have a broken sprinkler head? Is part of your lawn brown? Need to prepare your pipes for winter? Were here to help!
        </p>
