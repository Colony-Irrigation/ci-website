...
export function TextInput(props: ComponentProps<"input">) {
    return <input type="text" className="peer h-10 bg-black/10 rounded-lg focus:bg-black/20 focus:outline-1 outline-neutral-600 w-full p-2 " {...props} />
}
    ...
    return <div className="max-w-220 mx-auto">
        <div className="  shadow-neutral-600 rounded-lg m-4">
            <Form action={submit} className="p-4 bg-white-muted flex flex-col font-sans max-w-180 mx-auto rounded-lg">
                ...
                <button type="submit" className="rounded-lg m-4 h-12 text-xl peer-invalid:bg-black cursor-pointer bg-primary hover:brightness-90 text-white font-sans">Get Quote!</button>
            </Form>
        </div>
