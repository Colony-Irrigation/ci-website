...
export default function Navbar() {
    // Image is 414 x 75
    return <nav className="h-20 absolute  w-full bg-neutral-200 backdrop-blur-lg inset-shadow-white inset-shadow border-b-0 border-amber-900 shadow-md flex px-4  shadow-neutral-700 z-100">

        <Link href="/" className="mx-auto lg:mx-4 my-auto text-nowrap items-center italic font-bold flex h-full">
            <Image src={"/LogoTemp.png"} width={358} height={228} alt="Site logo" className="object-contain h-full w-fit p-2" />
            <div className="pl-2">
